    ...
    <div>
      <div className=" flex w-full text-center text-4xl sm:text-8xl font-light leading-tight text-white mt-80 sm:mt-96 flex-col">
        <h1 className={`${share_tech_mono.className}`}>
          <span className="lg:text-9xl text-transparent bg-clip-text bg-gradient-to-r from-zinc-800 to-red-600  hover:drop-shadow-lg">The<span className="myPulse text-red-600">_</span> embedded community </span>
        </h1>
